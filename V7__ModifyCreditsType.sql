...
END ELSE BEGIN
    IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID('Course') AND name = 'Credits') AND (SELECT system_type_id from sys.columns WHERE object_id = OBJECT_ID('Course') and name = 'Credits') = 56
    BEGIN
